...
import in.callkr.model.Student;
...
public class CallkrController {
	...
	public String testController(ModelMap model){
		model.addAttribute("testmessage","controller Tested..!!");
...
//===============
	...
	public String saveRegistration(@Valid Student student,BindingResult result,ModelMap model){
		...
		model.addAttribute("success","Dear "+student.getFirstName()+" you have successfully registred..!!");
		return "success";	
	}
	...
	public List<String> initilizedSections(){
